...
public class YouTubeActivity extends AppCompatActivity {
    private static final String[] YOUTUBE_PLAYLISTS = {
            ...
            "PLItqFRzgD5SQpgWuN9ziOh9Pa2kX8EE3h",
            "PL3oW2tjiIxvTSdJ4zqjL9dijeZ0LjcuGS",
            "PL-oM5qTjmK2vxdTsj2Xghu5fjxhtuMaxo",
            "PLp-A_R4zSGt4tnTZ_g-rI9lTb4_4d9irO",
            "PLJ3M6AoVR-gZtOkB4v-_XgzYQz_6UQssJ",
            "PLEpfh9jiEpYTbAx1qZRhVUXnl8UHuTHIY",
            "PLULWRF3aOPJPC_eoHlE-BPfa8mIhxMXRW",
            "PLo-aWo3UYpMSzIwFwCRENlBQKjP8URQUA",
            "PLrylsXfmkpclA55nQKJwufnh5T19osEXz",
            "PL2HEDIx6Li8jqhOAi7wQb18wXQ3oeLAO8",
            "PL_yIBWagYVjyNcL_CcZaI7GObwf0ltthw"
...
//            getSupportFragmentManager().beginTransaction()
//                    .replace(R.id.container, YouTubeRecyclerViewFragment.newInstance(mYoutubeDataApi, new String[]{"PLK_opvkxlemWiF-LEw1nsaksN5GXPIrAK"}))
//                    .commit();
//            return true;
//        }
